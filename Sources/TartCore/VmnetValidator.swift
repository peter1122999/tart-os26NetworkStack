...
public struct VmnetValidationResult {
  public let errors: [VmnetError]
...
public enum VmnetValidator {
  ...
  public static func validateReservations(_ reservations: [Reservation], subnet: CIDRBlock?) -> [VmnetError] {
    var errors: [VmnetError] = []
  ...
  public static func normalizeMACAddress(_ raw: String) -> String? {
  ...
  public static func validateExclusivity(_ requestedModes: [NetworkMode]) -> VmnetValidationResult {
