...
public struct Diskutil {
  public static func imageCreate(diskURL: URL, sizeGB: UInt16) throws {
    do {
      _ = try run([
        "image", "create", "blank",
        "--format", "ASIF",
  ...
  public static func imageInfo(_ diskURL: URL) throws -> ImageInfo {
    do {
