...
public struct DiagnosticsBundle {
  ...
  public var vmnetConfig: VmnetConfig?
  public var runtimeState: VmnetRuntimeState?
  public var ipResolutionAttempts: [IPResolutionAttempt] = []
  public var stdoutTail: [String] = []
  public var stderrTail: [String] = []
  public var lifecycleFailure: VmnetError?

  public init(
    vmName: String,
    networkMode: NetworkMode? = nil,
    vmnetConfig: VmnetConfig? = nil,
    runtimeState: VmnetRuntimeState? = nil,
    ipResolutionAttempts: [IPResolutionAttempt] = [],
    stdoutTail: [String] = [],
    stderrTail: [String] = [],
    lifecycleFailure: VmnetError? = nil
  ) {
    self.vmName = vmName
    self.networkMode = networkMode
    self.vmnetConfig = vmnetConfig
    self.runtimeState = runtimeState
    self.ipResolutionAttempts = ipResolutionAttempts
...
public enum VmnetDiagnostics {
  public static func summarize(_ bundle: DiagnosticsBundle) -> String {
    var lines: [String] = []
  ...
  public static func suggestedFixes(_ bundle: DiagnosticsBundle) -> [String] {
    var fixes: [String] = []
