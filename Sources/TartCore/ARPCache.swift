...
public struct ARPCommandFailedError: Error, CustomStringConvertible {
...
public struct ARPCommandYieldedInvalidOutputError: Error, CustomStringConvertible {
...
public struct ARPCacheInternalError: Error, CustomStringConvertible {
  public var explanation: String
...
public struct ARPCache {
  public let arpCommandOutput: Data
  ...
  public func ResolveMACAddress(macAddress: MACAddress) throws -> IPv4Address? {
...
public extension NSTextCheckingResult {
  public func getCaptureGroup(name: String, for string: String) throws -> String {
