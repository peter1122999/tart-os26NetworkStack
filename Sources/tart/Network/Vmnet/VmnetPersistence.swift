...
/// hard-failing.
enum VmnetPersistence {
  static func load(from url: URL) throws -> VmnetConfig? {
  ...
  static func save(_ config: VmnetConfig, to url: URL) throws {
    var config = config
  ...
  /// behavior.
  static func migrate(_ data: Data) throws -> VmnetConfig {
