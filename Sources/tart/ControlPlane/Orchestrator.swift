...
struct OrchestrationResult {
  var finalState: VMLifecycleState
  var resolvedIP: String?
  var diagnostics: DiagnosticsBundle
  var attempts: Int
...
actor VMOrchestrator {
  ...
  func start(_ request: OrchestrationRequest, vmDirectory: VMDirectory) async -> OrchestrationResult {
